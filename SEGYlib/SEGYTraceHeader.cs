...
namespace SEGYlib
{
    ...
    public class SEGYTraceHeader
    {
        ...
        public SEGYTraceHeader()
        {
            ...
            isBigEndian = true;
            isInitialized = false;
            this.iTraceHeaderBuffer = new byte[240];
        }
        ...
        // added to check  bytes of trace header for Potter
        public int byte214
        {
            get
            {
                return (int)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 214, 1, false, isBigEndian);
            }
            set
            {
            }
        ...
        public int byte215
        {
            get
            {
                return (int)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 215, 1, false, isBigEndian);
            }
            set
            {
            }
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// frequency channel code
        /// </summary>
        public short Kel_SpmCode
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 180, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// Time @ start of ping hours
        /// </summary>
        public short Kel_PingStartTimeHr
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 182, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// Time @ start of ping minutes
        /// </summary>
        public short Kel_PingStartTimeMin
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 184, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// Time @ start of ping seconds
        /// </summary>
        public short Kel_PingStartTimeSec
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 186, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// Time @ start of ping msec
        /// </summary>
        public short Kel_PingStartTimeMs
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 188, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// transmit powere parameter setting ( 1 to 8 ) 
        /// </summary>
        public short Kel_TxPower
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 190, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// receiver gain parameter setting ( 0 to 255 ) 
        /// </summary>
        public short Kel_RxGain
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 192, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// processing grain parameter setting ( 0 to 8 ) 
        /// </summary>
        public short Kel_ProcessingGain
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 194, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// sensitivity parameter setting ( 1 to 100 )
        /// </summary>
        public short Kel_Sensitivity
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 196, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// </summary>
        public short Kel_MuxChannel
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 198, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// echo strenght measured in dB
        /// </summary>
        public short Kel_EchoStrength
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 200, 2, true, isBigEndian);
        ...
        /// </summary>
        public short Kel_PrimaryChannel
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 202, 2, true, isBigEndian);
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// pulse length parameter selection codes 
        /// </summary>
        public short Kel_PulseLength
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 204, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// transmit blanking parameters expressed in 1/10 system units
        /// </summary>
        public short Kel_TxBlank
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 206, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// Latency since heave data received (sec)
        /// </summary>
        public short Kel_HeaveSensorLatency
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 218, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// Latency since GPS data received (sec)
        /// </summary>
        public short Kel_GPSLatency
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 220, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// event Mark Code : 0 = no event mark
        /// </summary>
        public short Kel_EventMarkCode
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 222, 2, true, isBigEndian);
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// Event Marker if event present
        /// </summary>
        public short Kel_EventMarkNumber
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 224, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// <summary>
        /// for Knudsen SEGY REV 0 Extended SEGY
        /// scalar applied to digitizer depth and sampling data rate
        /// </summary>
        public short Kel_Scalar
        {
            get
            {
                return (short)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 226, 2, true, isBigEndian);
            }
            set
            {
            }
        ...
        /// Sampline Data rate
        /// </summary>
        public int Kel_DataRate
        {
            get
            {
                return (int)SEGYUtilities.Bytes2Int(this.iTraceHeaderBuffer, 228, 4, true, isBigEndian);
            }
            set
            {
            }
