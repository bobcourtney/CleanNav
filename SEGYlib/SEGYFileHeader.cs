...
namespace SEGYlib
{
    ...
    public class SEGYFileHeader
    {
        ...
        public SEGYFileHeader()
        {
            ...
            iExtendedTextHeader.Add(new byte[3200]); // preinitialize with 3200 0th order TextHeader
            iBinaryFileHeader =  new byte[400];
            BigEndian = true; // by default, segy is big endian
            detectedSEGYVer0 = false; // some SEG's rev 0 have crap in the wrong places;
            isSEGYFileHeaderAscii = true;
        ...
        /// <summary>
        /// set the file header to  ASCII 
        /// </summary>
        /// <returns>true if file header text is ASCII formatted</returns>

        public void  setFileHeaderASCII(bool direction)
        {
                byte[] header = this.ExtendedTextHeader[0];
                ...
                { 
                    ...
                    header = Encoding.Convert(ebcdic, utf8, header);
                    this.ExtendedTextHeader[0] = header;
                }
        ...
        public void SetFileHeader(int block, int line, string str)
        {
            ...
            Array.Copy(buffer, 0, ExtendedTextHeader[block], line * 80, buffer.Length);
        }
    }
}
