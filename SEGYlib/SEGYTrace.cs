    ...
    public class SEGYTrace
    {
        ...
        public DateTime timeTracedRecorded
        {
            get
            {
                ...
                if (this.iSEGYTraceHeader.yearDataRecorded < 1800 || this.iSEGYTraceHeader.yearDataRecorded > 2100 )
                {
                    return t;
        ...
        /// <summary>
        /// group position X corrected for scaling factors
        /// </summary>
        public double receiverPositionX
        {
            get
            {
                return SEGYUtilities.convertToPosition(this.iSEGYTraceHeader.groupCoordinateX, this.iSEGYTraceHeader.coordinateUnits, this.iSEGYTraceHeader.scalarToBeAppliedToAllCoordinates);
            }
            set
            {
                this.iSEGYTraceHeader.groupCoordinateX = SEGYUtilities.convertPositionToint(value, this.iSEGYTraceHeader.coordinateUnits, this.iSEGYTraceHeader.scalarToBeAppliedToAllCoordinates);

            }
        }

        /// <summary>
        /// group position Y corrected for scaling factors
        /// </summary>
        public double receiverPositionY
        {
            get
            {
                return SEGYUtilities.convertToPosition(this.iSEGYTraceHeader.groupCoordinateY, this.iSEGYTraceHeader.coordinateUnits, this.iSEGYTraceHeader.scalarToBeAppliedToAllCoordinates);
            }
            set
            {
                this.iSEGYTraceHeader.groupCoordinateY = SEGYUtilities.convertPositionToint(value, this.iSEGYTraceHeader.coordinateUnits, this.iSEGYTraceHeader.scalarToBeAppliedToAllCoordinates);

            }
        }

        /// <summary>
        /// Offset Source and receiver recorded
        /// </summary>
        public double source_receiver_offset
        {
            get
            {
                return SEGYUtilities.convertToLength(this.iSEGYTraceHeader.distanceFromCenterOfSourcePointToCenterOfGroup, this.iSEGYTraceHeader.scalarForAllElevationsAndDepths);
            }
            set
            {
        ...
        public bool isLatLon
        {
            get
            {
                if (this.iSEGYTraceHeader.coordinateUnits == 1 || this.iSEGYTraceHeader.coordinateUnits == 0)
                {
                    return false;
                }
                else
