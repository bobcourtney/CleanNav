...
namespace SEGYlib
{
    ...
    public class SEGYFile
    {
        ...
        [NonSerialized()] public System.IO.BinaryReader SEGYreader;
        [NonSerialized()] public System.IO.BinaryWriter SEGYwriter;
        ...
        public int Open(string inputFilename)
        {
            try
            {
                ...
                {
                    System.IO.FileInfo fi = new System.IO.FileInfo(inputFilename);
                ...
                if (readOnly)
                {
                    this.SEGYreader = new System.IO.BinaryReader(System.IO.File.OpenRead(inputFilename));
                    this.SEGYwriter = null;
                }
                else
                {
                    try
        ...
        {
            SEGYreader.BaseStream.Position = this.positionOfEndofFileHeaders;
        ...
        public bool ReadNextTrace(bool onlyheader=false)
        {
            ...
            else
            {
                ...
                if (this.SEGYreader.BaseStream.Position + bytesToRead > this.SEGYreader.BaseStream.Length) return false;
