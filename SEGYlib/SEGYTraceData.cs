...
namespace SEGYlib
{
    ...
    public class SEGYTraceData
    {
        ...
        /// <param name="n">preallocate a trace data buffer of n points</param>
        public void Initialize(int format, bool bigendian, int n)
        {
            iformat = format;
            isbigendian = bigendian;
            int siz = n;
            if( format == 1 | format == 2| format == 4 || format == 5) siz = 4;
            if(format == 3 )siz = 2;
            this.TraceDataBuffer = new byte[siz * n];
        }
        /// <summary>
                    ...
                    switch (iformat)
                    {
                        ...
                        case 5:
                            ...
                            for (int i = 0; i < iTraceDataBuffer.Length / wordLength; i++)
                            {
                                ...
                                if( data[i] == Single.NaN || data[i] == Single.NegativeInfinity || data[i] == Single.PositiveInfinity ) data[i] = 0;
                            }
                            break;
                        case 8:
